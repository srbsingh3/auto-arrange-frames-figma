...
function getUserName() {
    var _a;
    try {
        return ((_a = figma.currentUser) === null || _a === void 0 ? void 0 : _a.name) || 'Anonymous User';
    }
    catch (error) {
...
async function trackEvent(eventName, properties) {
    try {
        ...
        const eventData = {
            event: eventName,
            properties: Object.assign(Object.assign({}, properties), { token: MIXPANEL_TOKEN, distinct_id: distinctId, time: Date.now() })
        };
